...
import { activateAccController, addBookController, extendTheController, lateController, listAccountController, listCopiesController, lockAccController, LogControllerforStaff, notificationStaffController, staffBorrowController, notificationStaffMarkReadController } from "../controllers/staffController";
...
router.post("/notifications/mark-read", notificationStaffMarkReadController);
