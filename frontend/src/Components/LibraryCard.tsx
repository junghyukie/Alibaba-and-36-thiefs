    ...
    <>
      <style>{`
        * { box-sizing: border-box; }
        ...
        .card {
          width:760px; max-width:95vw; min-height:280px; background: rgba(255,255,255,0.95);
        ...
        .card-header { font-size:1.6rem; font-weight:700; color:#1e3a8a; }
        .data-row { display:flex; gap:12px; align-items:center; }
        .data-label { min-width:140px; color:#374151; font-weight:600; }
        .data-value { flex:1; padding:10px 12px; background:#f8fafc; border-radius:8px; color:#111827; }
        .validity { display:flex; gap:8px; align-items:center; }
        ...
        .modal {
          background: white; padding: 32px; border-radius: 12px; width: 400px;
          box-shadow: 0 10px 25px rgba(0,0,0,0.2); display: flex; flex-direction: column; gap: 16px;
        }
        .modal h2 { margin: 0; font-size: 1.4rem; color: #1e3a8a; }
        .modal label { font-weight: 600; }
        .modal input[type="date"] {
          padding: 8px; border: 1px solid #ccc; border-radius: 6px;
        }
        .modal .readonly-box {
          background: #f3f4f6; padding: 10px; border-radius: 6px; color: #111827;
        }
        .modal button {
          padding: 10px 16px; background: #1e40af; color: white; border: none;
